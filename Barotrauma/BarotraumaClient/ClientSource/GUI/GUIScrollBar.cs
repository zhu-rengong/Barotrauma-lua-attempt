...
namespace Barotrauma
{
    public class GUIScrollBar : GUIComponent
    {
        ...
        public GUIScrollBar(RectTransform rectT, float barSize = 1, Color? color = null, [LuaAliasGUIComponentStyle] string style = "", bool? isHorizontal = null) : base(style, rectT)
        {
            CanBeFocused = true;
