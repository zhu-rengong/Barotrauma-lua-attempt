...
namespace Barotrauma
{
    ...
    internal class GUIContextMenu : GUIComponent
    {
        ...
        public GUIContextMenu(Vector2? position, LocalizedString header, [LuaAlias.GUIComponentStyle] string style, params ContextMenuOption[] options) : base(style, new RectTransform(Point.Zero, GUI.Canvas))
        {
