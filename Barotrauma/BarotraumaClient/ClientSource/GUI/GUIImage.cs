...
namespace Barotrauma
{
    public class GUIImage : GUIComponent
    {
        ...
        public GUIImage(RectTransform rectT, [LuaAliasGUIComponentStyle] string style, bool scaleToFit = false)
        ...
        private GUIImage(RectTransform rectT, Sprite sprite, Rectangle? sourceRect, bool scaleToFit, [LuaAliasGUIComponentStyle] string style) : base(style, rectT)
        {
