...
namespace Barotrauma
{
    public class GUIImage : GUIComponent
    {
        ...
        public GUIImage(RectTransform rectT, [LuaAlias.GUIComponentStyle] string style, bool scaleToFit = false)
        ...
        private GUIImage(RectTransform rectT, Sprite sprite, Rectangle? sourceRect, bool scaleToFit, [LuaAlias.GUIComponentStyle] string style) : base(style, rectT)
        {
