...
namespace Barotrauma
{
    class SerializableEntityEditor : GUIComponent
    {
        ...
        public SerializableEntityEditor(RectTransform parent, ISerializableEntity entity, bool inGame, bool showName, [LuadocGUIComponentStyle] string style = "", int elementHeight = 24, GUIFont titleFont = null)
        ...
        public SerializableEntityEditor(RectTransform parent, ISerializableEntity entity, IEnumerable<SerializableProperty> properties, bool showName, [LuadocGUIComponentStyle] string style = "", int elementHeight = 24, GUIFont titleFont = null)
